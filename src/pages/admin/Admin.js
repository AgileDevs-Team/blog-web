...
import './Admin.css';
import { fecthAllPosts } from '../../services/posts-service'
...
class Admin extends Component {
    ...
    clickEditPost(event){
        const id = event.currentTarget.getAttribute("data-row-id");
        console.log(id);
    }
                                    ...
                                    <td>
                                        <div className="row">
                                            <div className="col-md-1">
                                                <svg data-row-id={post.id} onClick={this.clickEditPost} className="bi bi-pencil" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
